...
The data from the initial study was downloaded off of NCBI, then re-proscessed and re-mapped using several programs. First, trimmomatic was used to properly clean and proscess the sequences from the initial RNAseq dataset. [@bolger2014] BioMart was used to download the annotated reference genomes that the RNA sequences would be mapped to. [@durinck2005] This RNAseq information mapped to these reference genomes usingsailfish. [@patro_mount_kingsford_2014] Finally, the cleaned RNAseq data and its associated metadata was analyzed in R using extensions such as ggplott
