...
top_f_in_all_status %>%
  ...
  facet_wrap(~smoking_status) +
  geom_col(position = "dodge") +
  ggtitle("Expression of most common genes in female patients in all patients by smoking status") +
  xlab("Gene name") +
  ylab("Mean read counts per gene") +
  theme_bw() +
  theme(axis.text.x =
...
top_f_in_all_stage %>%
  ...
  facet_wrap(~cancer_stage) +
  geom_col(position = "dodge") +
  ggtitle("Expression of most common genes in female patients in all patients by cancer stage") +
  xlab("Gene name") +
  ylab("Mean read counts per gene") +
  theme_bw() +
  theme(axis.text.x =
